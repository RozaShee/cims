...
<body data-spy="scroll" data-target=".site-navbar-target" data-offset="200">
  ...
  <div class="site-blocks-cover overlay" style="background-image: url(/cims/server/uploads/settings/home_image.jpg);" data-aos="fade" data-stellar-background-ratio="0.5" id="section-home">
    <div class="container">
      ...
      while ($row = mysqli_fetch_assoc($getall)) {
        ...
        <div>
          <a href="#" class="unit-1 text-center">
            <img src="<?php echo $img_src; ?>" alt="Image" class="img-fluid" style="width: 300px; height: 200px;">
  ...
  <div class="site-blocks-cover overlay inner-page-cover" style="background-image: url(/cims/server/uploads/gallery/image_parcel.jpg); background-attachment: fixed;">
    <div class="container">
      <div class="row align-items-center justify-content-center text-center">
