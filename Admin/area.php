...
<tr>
    ...
    <td>
        <button type="button" onclick="deleteData(<?php echo $row['area_id']; ?>, 'area', 'area_id')" class="btn btn-darkblue">
    ...
    <script>
    function deleteData(areaId, entityType, entityId) {
        // Display a custom confirmation prompt
        var confirmed = window.confirm('Are you sure you want to delete this area?');

        if (confirmed) {
            // Assuming you're using AJAX to send a request to delete the area
