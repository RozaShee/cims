                                ...
                                <tbody>
                                    ...
                                    while ($row = mysqli_fetch_assoc($getall)) {
                                        ...
                                        <tr>
                                            ...
                                            <td>
    <button type="button" onclick="deleteData(<?php echo $row['price_id']; ?>, 'price_table', 'price_id')" class="btn btn-darkblue">
...
<script>
    function deleteData(priceId, entityType, entityId) {
        // Display a custom confirmation prompt
        var confirmed = window.confirm('Are you sure you want to delete this price entry?');

        if (confirmed) {
            // Assuming you're using AJAX to send a request to delete the price entry
            ...
            .then(data => {
                ...
                console.log('Price entry deleted successfully:', data);
