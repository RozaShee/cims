...
<body data-spy="scroll" data-target=".site-navbar-target" data-offset="200">
    ...
    <div class="site-blocks-cover overlay" style=" height: 100px; background-image: url(/cims/server/uploads/settings/home_image.jpg);" data-aos="fade" data-stellar-background-ratio="0.5" id="section-home">
        <div class="container">
   ...
   <!-- <div class="track">
        ...
        <!-- Cancel Order Step 
        <div class="step <?php if ($row['tracking_status'] == 5) {
                                echo 'active';
                            } ?>">
...
<?php } ?>
                                ...
                                <a href="cancel_order.php?request_id=<?php echo $row['request_id']; ?>" class="btn btn-danger">Cancel Order</a>
